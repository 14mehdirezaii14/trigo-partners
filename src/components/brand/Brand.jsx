...
const Brand = ({width, height, alt}) => {
    return (
        <MainBrand className="main-brand" width={width} height={height}>
            <img className="logo-light" src={'/assets/img/project/project1/trigo 2.svg'} alt={`${alt} - logo light`} width={width} height={height}/>
            <img className="logo-dark" src={'/assets/img/project/project1/trigo 2.svg'} alt={`${alt} - logo dark`} width={width} height={height}/>
        </MainBrand>
    );
}
